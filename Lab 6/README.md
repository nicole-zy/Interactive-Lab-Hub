...
Two friends are playing trumpet remotely for each other during quarantine. Due to the pandemic, the friends can't meet up and practice together, so they want to make the practice session remote.
